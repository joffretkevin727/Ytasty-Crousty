...
def modify_restaurant(restaurant_id: int, restaurant_data: RestaurantUpdate, db=Depends(get_db)):
...
def modify_restaurant_status(restaurant_id: int, status_data: RestaurantStatusUpdate, db=Depends(get_db)):
